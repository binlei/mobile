...
$(function() { 
	...
	//默认加载数据
	loadData('dataChart','季度数据','seasonUsage','dataTable');
	rigntClick();
});
  	...
  	<!-- 查询表单 -->
		<div class="Search-box" region="north" title="查询条件" style="height:185px;">
			<form id="srchForm" class="frmSearch" action="" autocomplete='off' method="post">
				...
				<table class="tableForm"  align="center" style="width:1200px;">
					<tr>
						<th>渠道</th>
					...
					<tr>
						<td colspan="6" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="tj_search('dataChart','季度数据','seasonUsage','dataTable','season')">查询数据</a>&nbsp;&nbsp;&nbsp;
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="historyMax('topNChart','季到达TOP N','seasonUsageTop','topNTable')">历史最高</a>&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
				</table>
			</form>
