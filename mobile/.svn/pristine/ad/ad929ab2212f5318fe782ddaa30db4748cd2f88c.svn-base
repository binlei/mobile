...
$(function() { 
	...
	setTime('month');
	//默认加载数据
	loadData('dataChart','月度数据','monthUsage','dataTable');
	rigntClick();
});
				...
				<table class="tableForm"  align="center" style="width:1100px;">
					...
					<tr>
						<td colspan="6" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="tj_search('dataChart','月度数据','monthUsage','dataTable','month')">查询数据</a>&nbsp;&nbsp;&nbsp;
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="historyMax('topNChart','月到达TOP N','monthUsageTop','topNTable')">历史最高</a>&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
				</table>
			</form>
