...
$(function() { 
	...
	//默认加载数据
	loadData('dataChart','季度数据','seasonArrival','dataTable');
	rigntClick();
});
				...
				<table class="tableForm"  align="center" style="width:900px;">
					...
					<tr>
						<td colspan="4" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="tj_search('dataChart','季度数据','seasonArrival','dataTable','season')">查询数据</a>&nbsp;&nbsp;&nbsp;
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="historyMax('topNChart','季到达TOP N','seasonArrivalTop','topNTable')">历史最高</a>&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
				</table>
			</form>
