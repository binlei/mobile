...
$(function() { 
	...
	setTime('day');
	//默认加载数据
	loadData('dataChart','日度数据','dayActivated','dataTable');
	//右键菜单
	rigntClick();
});
				...
				<table class="tableForm"  align="center" style="width:900px;">
					...
					<tr>
						<td colspan="4" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="tj_search('dataChart','日度数据','dayActivated','dataTable','day')">查询数据</a>&nbsp;&nbsp;&nbsp;
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="historyMax('topNChart','日到达TOP N','dayActivatedTop','topNTable')">历史最高</a>&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
				</table>
			</form>
