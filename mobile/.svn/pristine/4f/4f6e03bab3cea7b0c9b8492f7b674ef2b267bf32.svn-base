...
<script type="text/javascript">
	...
	$(function() {
		...
		srchForm = $("#srchForm");		
		sy.createDatagrid($("#mobileAppInstalled"),srchForm);
		sy.pageButtons($("#mobileAppInstalled"));
	});
	
	//获取所选记录ID
	function getSelections() {
		return sy.getSelectionsIds($("#mobileAppInstalled"));
	}
</script>

</head>
<body class="easyui-layout" style="width:100%;height:100%;"
	onkeydown="javascript:keyPressImpl(event,'mobileAppInstalled');" onkeyup="javascript:keyReleaseImpl(event,'mobileAppInstalled');">
  	<!-- 查询表单 -->
		<div id="srchDiv" class="easyui-dialog" closed="true" title="查找" style="width:450px;height:350px;">
			<form id="srchForm" class="frmSearch" action="" autocomplete='off'>
				<input type="hidden" name="bean" value="mobileAppInstalled">
				...
				<table class="tableForm"  align="center" style="">
					...
					<tr>
						<td colspan="2" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="tj_query('mobileAppInstalled')">查询</a>&nbsp;&nbsp;&nbsp;
	...
	<!-- 数据表格 -->
		<div region="center" style="width:100%;height:100%;border:0;">
			<table id="mobileAppInstalled" style="text-align:center;">
				<thead>   
			       <tr>  
			           ...
			           <th data-options="field:'updateTime',width:150,sortable : true">更新时间</th>
