...
$(function() { 
	//显示当前时间	
	$("#installEndTime").datebox("setValue", curr_time.format("yyyy-MM-dd"));
	curr_time.setDate(curr_time.getDate()-7);
	$("#installStartTime").datebox("setValue", curr_time.format("yyyy-MM-dd"));
...
<body class="easyui-layout" style="width: 100%; height: 100%;"
	...
	<div class="Search-box" region="north" title="装机明细" style="height: 150px;">
		<form id="srchForm" class="frmSearch" action="exportExcelSuccess" method="post" autocomplete='off'>
			...
			<table class="tableForm" style="width: 1000px">
				...
				<tr>
					...
					<td colspan="3" align="center">
						<a href="javascript:void(0)" class="easyui-linkbutton" id="queryId">查询</a>&nbsp;&nbsp;&nbsp;
		...
		<table id="appInstallLog">
			<thead>
				<tr>
					...
					<th data-options="field:'installStatus',width:80,sortable : true,formatter:format_installLog">装机结果</th>
				</tr>
			</thead>
		</table>
		<div id="container"
