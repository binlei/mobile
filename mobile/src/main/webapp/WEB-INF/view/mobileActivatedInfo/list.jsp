...
var srchForm ;
	$(function() {
		...
		srchForm = $("#srchForm");		
		sy.createDatagrid($("#mobileActivatedInfo"),srchForm);
		sy.pageButtons($("#mobileActivatedInfo"));
	});
	
	//获取所选记录ID
	function getSelections() {
		return sy.getSelectionsIds($("#mobileActivatedInfo"));
	}
...
<body class="easyui-layout" style="width:100%;height:100%;" 
	onkeydown="javascript:keyPressImpl(event,'mobileActivatedInfo');" onkeyup="javascript:keyReleaseImpl(event,'mobileActivatedInfo');">
	<!-- 查询表单 -->
		<div id="srchDiv" class="easyui-dialog" closed="true" title="查找" style="width:450px;height:350px;">
			<form id="srchForm" class="frmSearch" action="" autocomplete='off'>
				<input type="hidden" name="bean" value="mobileActivatedInfo">
				...
				<table class="tableForm"  align="center" style="">
					...
					<tr>
						<th>上传日期</th>
						<td>
							<input id="a" name="uploadTime_from" editable="false" class="timeInput easyui-datebox" style="width:120px;"/>至
					...
					<tr>
						<td colspan="2" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="tj_query('mobileActivatedInfo')">查询</a>&nbsp;&nbsp;&nbsp;
			...
			<table id="mobileActivatedInfo">
				<thead>   
			       <tr>  	
			           ...
			           <th data-options="field:'activatedTime',width:150,sortable : true">激活时间</th>
