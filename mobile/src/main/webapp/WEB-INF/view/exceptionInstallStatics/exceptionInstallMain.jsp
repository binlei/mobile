...
<script type="text/javascript">
	...
	function showData(type) {
		...
		var content = "<iframe frameborder='0' width='100%' height='680px' src='${pageContext.request.contextPath}/appInstallLog/"+type+"'></iframe>";
		$("#main").html(content);
	}
</script>
...
<body style="overflow: auto;">
	<div class="content">
		...
		<div id="main" class="main">
			<iframe frameborder="0" width="100%" height="680px" src="${pageContext.request.contextPath}/appInstallLog/day"></iframe>
		</div>
	</div>
</body>
</html>
