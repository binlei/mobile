...
$(function() { 
	...
	setTime('year');
	//默认加载数据
	loadData('dataChart','年度数据','yearUsage','dataTable');
	rigntClick();
});
				...
				<table class="tableForm"  align="center" style="width:1100px;">
					...
					<tr>
						<td colspan="6" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="tj_search('dataChart','年度数据','yearUsage','dataTable','year')">查询数据</a>&nbsp;&nbsp;&nbsp;
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="historyMax('topNChart','年到达TOP N','yearUsageTop','topNTable')">历史最高</a>&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
				</table>
			</form>
