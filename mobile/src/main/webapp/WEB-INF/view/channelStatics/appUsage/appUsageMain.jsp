...
<script type="text/javascript">
	...
	function showData(type) {
		...
		var content = "<iframe frameborder='0' width='100%' height='650px' src='${pageContext.request.contextPath}/appUsage/"+type+"'></iframe>";
		$("#main").html(content);
	}
</script>
...
<body style="overflow: auto">
	<div class="content">
		...
		<div id="main" class="main">
			<iframe frameborder="0" width="100%" height="650px" src="${pageContext.request.contextPath}/appUsage/day"></iframe>
		</div>
	</div>
</body>
</html>
