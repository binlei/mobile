...
$(function() { 
	...
	setTime2('year');
	//默认加载数据
	loadData('dataChart','年度数据','yearPopularTop','dataTable');
	rigntClick();
});
				...
				<table class="tableForm"  align="center" style="width:800px;">
					...
					<tr>
						<td colspan="6" align="center">
							<a href="javascript:void(0)" class="easyui-linkbutton"onclick="tj_search2('dataChart','年度数据','yearPopularTop','dataTable','year')">查询数据</a>&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
				</table>
			</form>
